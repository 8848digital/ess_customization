...
# 	{
# 		"name": "ess",
# 		"logo": "/assets/ess/logo.png",
# 		"title": "ESS",
# 		"route": "/ess",
# 		"has_permission": "ess.api.permission.has_app_permission",
# 	}
# ]
...
# `ess/dock/ess/ess.json` for git to carry. An app that ships none has no
...
# app_include_icons = "ess/public/icons.svg"
...
# before_uninstall = "ess.uninstall.before_uninstall"
# after_uninstall = "ess.uninstall.after_uninstall"
...
# before_disable = "ess.uninstall.before_disable"
# after_disable = "ess.uninstall.after_disable"
# before_enable = "ess.install.before_enable"
# after_enable = "ess.install.after_enable"
...
# before_app_install = "ess.utils.before_app_install"
# after_app_install = "ess.utils.after_app_install"
...
# before_app_uninstall = "ess.utils.before_app_uninstall"
# after_app_uninstall = "ess.utils.after_app_uninstall"

# Build
# ------------------
# To hook into the build process

# after_build = "ess.build.after_build"

# To hook into the build process of other apps
# The list of apps being built is passed as an argument

# after_app_build = "ess.build.after_app_build"
...
# awesomebar_search = ["ess.search.awesomebar_results"]
...
# 	"Task": "ess.custom.task.CustomTaskMixin"
# }
...
# Request Events
# ----------------
# before_request = ["ess.utils.before_request"]
# after_request = ["ess.utils.after_request"]

# Job Events
# ----------
# before_job = ["ess.utils.before_job"]
# after_job = ["ess.utils.after_job"]

# after_file_upload = ["ess.utils.after_file_upload"]
